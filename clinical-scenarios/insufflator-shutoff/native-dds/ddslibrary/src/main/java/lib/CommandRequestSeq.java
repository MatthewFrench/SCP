...
/**
 * A sequence of CommandRequest instances.
 */
public final class CommandRequestSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public CommandRequestSeq() {
        super(CommandRequest.class);
    }


    public CommandRequestSeq(int initialMaximum) {
        super(CommandRequest.class, initialMaximum);
    }


    public CommandRequestSeq(Collection elements) {
        super(CommandRequest.class, elements);
    }
