 ...
 */
public class CommandCompletionStatusTypeSupport extends TypeSupportImpl {    
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "CommandCompletionStatus";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};

    private static final CommandCompletionStatusTypeSupport _singleton
        = new CommandCompletionStatusTypeSupport();    
    ...
    public static CommandCompletionStatusTypeSupport get_instance() {
        return _singleton;
    }

    /* deprecated API */
    public static CommandCompletionStatusTypeSupport getInstance() {
        return get_instance();
    }
     ...
     * So, for example:
     *    myEnumField = CommandCompletionStatusTypeSupport.get_instance().copy_data(anotherInstanceOfEnum);
    ...
    public Class get_type() {
        return CommandCompletionStatus.class;
    }
    ...
    public void serialize(Object endpoint_data,Object src, CdrOutputStream dst, boolean serialize_encapsulation, short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
CommandCompletionStatus typedSrc = (CommandCompletionStatus) src;   
    ...
    public Object deserialize_sample(
        ...
        if(deserialize_sample) {
            ...
            dst = CommandCompletionStatus.valueOf(ordinal);
    ...
    protected CommandCompletionStatusTypeSupport() {
        
            super(TYPE_NAME, false /*no key*/,CommandCompletionStatusTypeCode.VALUE,CommandCompletionStatus.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
