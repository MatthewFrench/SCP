...
@rem ##########################################################################
@rem
@rem  pulseoximeter startup script for Windows
@rem
@rem ##########################################################################
...
@rem Execute pulseoximeter
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SAMPLE_OPTS%  -classpath "%CLASSPATH%" clinicalscenario.simplemonitor.Launcher %CMD_LINE_ARGS%
