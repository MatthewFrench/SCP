 ...
 * CompletionStatus.
 */
public class CompletionStatusTypeSupport extends TypeSupportImpl {    
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "CompletionStatus";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};

    private static final CompletionStatusTypeSupport _singleton
        = new CompletionStatusTypeSupport();    
    ...
    public static CompletionStatusTypeSupport get_instance() {
        return _singleton;
    }

    /* deprecated API */
    public static CompletionStatusTypeSupport getInstance() {
        return get_instance();
    }
     ...
     * So, for example:
     *    myEnumField = CompletionStatusTypeSupport.get_instance().copy_data(anotherInstanceOfEnum);
    ...
    public void serialize(Object endpoint_data,Object src, CdrOutputStream dst, boolean serialize_encapsulation, short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
CompletionStatus typedSrc = (CompletionStatus) src;   
    ...
    public Object deserialize_sample(
        ...
        if(deserialize_sample) {
            ...
            dst = CompletionStatus.valueOf(ordinal);
    ...
    protected CompletionStatusTypeSupport() {
        
            super(TYPE_NAME, false /*no key*/,CompletionStatusTypeCode.VALUE,CompletionStatus.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
