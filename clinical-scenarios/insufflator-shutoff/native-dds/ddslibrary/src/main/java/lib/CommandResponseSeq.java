...
/**
 * A sequence of CommandResponse instances.
 */
public final class CommandResponseSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public CommandResponseSeq() {
        super(CommandResponse.class);
    }


    public CommandResponseSeq(int initialMaximum) {
        super(CommandResponse.class, initialMaximum);
    }


    public CommandResponseSeq(Collection elements) {
        super(CommandResponse.class, elements);
    }
