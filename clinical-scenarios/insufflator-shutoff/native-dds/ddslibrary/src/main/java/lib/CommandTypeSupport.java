...
public class CommandTypeSupport extends TypeSupportImpl {    
     ...
     * So, for example:
     *    myEnumField = CommandTypeSupport.get_instance().copy_data(anotherInstanceOfEnum);
...
Command typedSrc = (Command) src;   
    ...
    protected CommandTypeSupport() {
            ...
            super(TYPE_NAME, false /*no key*/,CommandTypeCode.VALUE,Command.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
