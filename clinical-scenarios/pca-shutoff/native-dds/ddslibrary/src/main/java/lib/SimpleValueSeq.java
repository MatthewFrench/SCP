...
/**
 * A sequence of SimpleValue instances.
 */
public final class SimpleValueSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public SimpleValueSeq() {
        super(SimpleValue.class);
    }


    public SimpleValueSeq(int initialMaximum) {
        super(SimpleValue.class, initialMaximum);
    }


    public SimpleValueSeq(Collection elements) {
        super(SimpleValue.class, elements);
    }
