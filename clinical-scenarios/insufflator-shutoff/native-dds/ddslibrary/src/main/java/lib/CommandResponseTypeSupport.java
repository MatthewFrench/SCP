 ...
 * CommandResponse.
 */
public class CommandResponseTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "CommandResponse";
    ...
    private static final CommandResponseTypeSupport _singleton
        = new CommandResponseTypeSupport();
     ...
     */
    public static CommandResponseTypeSupport get_instance() {
        return _singleton;
    }

    public static CommandResponseTypeSupport getInstance() {
        return get_instance();
    }
     ...
     * <code>this</code> is not a <code>CommandResponse</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        CommandResponse typedDst = (CommandResponse) destination;
        CommandResponse typedSrc = (CommandResponse) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  lib.CompletionStatusTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  lib.CompletionStatusTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        CommandResponse typedSrc = (CommandResponse) sample;
        ...
        currentAlignment += lib.CompletionStatusTypeSupport.get_instance().get_serialized_sample_size(
...
CommandResponse typedSrc = (CommandResponse) src;    
        ...
        lib.CompletionStatusTypeSupport.get_instance().serialize(endpoint_data,  typedSrc.status, dst, false, encapsulation_id,true,endpoint_plugin_qos);            
...
CommandResponse typedDst = (CommandResponse) dst;
        
            typedDst.clear();
    try {

            typedDst.status = (lib.CompletionStatus)lib.CompletionStatusTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.status, src, false, true, endpoint_plugin_qos);            
...
CommandResponse typedDst = (CommandResponse) dst;
                     ...
                     Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            lib.CompletionStatusTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
CommandResponse typedDst = (CommandResponse) sample;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new CommandResponseDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new CommandResponseDataReader(native_reader, listener, mask, this);                
    ...
    protected CommandResponseTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,CommandResponseTypeCode.VALUE,CommandResponse.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected CommandResponseTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,CommandResponseTypeCode.VALUE,CommandResponse.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
