...
@rem ##########################################################################
@rem
@rem  bpmonitor startup script for Windows
@rem
@rem ##########################################################################
...
@rem Execute bpmonitor
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SAMPLE_OPTS%  -classpath "%CLASSPATH%" clinicalscenario.bpmonitor.Launcher %CMD_LINE_ARGS%
