 ...
 * SimpleValue.
 */
public class SimpleValueTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "SimpleValue";
    ...
    private static final SimpleValueTypeSupport _singleton
        = new SimpleValueTypeSupport();
     ...
     */
    public static SimpleValueTypeSupport get_instance() {
        return _singleton;
    }

    public static SimpleValueTypeSupport getInstance() {
        return get_instance();
    }
     ...
     * <code>this</code> is not a <code>SimpleValue</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        SimpleValue typedDst = (SimpleValue) destination;
        SimpleValue typedSrc = (SimpleValue) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        SimpleValue typedSrc = (SimpleValue) sample;
...
SimpleValue typedSrc = (SimpleValue) src;    
        ...
        dst.writeShort(typedSrc.srcId);        
            
        dst.writeShort(typedSrc.trgId);        
            
        dst.writeShort(typedSrc.value);        
...
SimpleValue typedDst = (SimpleValue) dst;
        
            typedDst.clear();
    try {

            typedDst.srcId = src.readShort();
            
            typedDst.trgId = src.readShort();
            
            typedDst.value = src.readShort();
...
SimpleValue typedDst = (SimpleValue) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
SimpleValue typedDst = (SimpleValue) sample;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new SimpleValueDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new SimpleValueDataReader(native_reader, listener, mask, this);                
    ...
    protected SimpleValueTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SimpleValueTypeCode.VALUE,SimpleValue.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected SimpleValueTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,SimpleValueTypeCode.VALUE,SimpleValue.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
