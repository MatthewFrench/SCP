...
@rem ##########################################################################
@rem
@rem  insufflationpump startup script for Windows
@rem
@rem ##########################################################################
...
@rem Execute insufflationpump
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SAMPLE_OPTS%  -classpath "%CLASSPATH%" clinicalscenario.insufflationpump.Launcher %CMD_LINE_ARGS%
