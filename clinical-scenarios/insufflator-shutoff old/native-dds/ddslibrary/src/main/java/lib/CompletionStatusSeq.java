...
/**
 * A sequence of CompletionStatus instances.
 */
public final class CompletionStatusSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public CompletionStatusSeq() {
        super(CompletionStatus.class);
    }


    public CompletionStatusSeq(int initialMaximum) {
        super(CompletionStatus.class, initialMaximum);
    }


    public CompletionStatusSeq(Collection elements) {
        super(CompletionStatus.class, elements);
    }
