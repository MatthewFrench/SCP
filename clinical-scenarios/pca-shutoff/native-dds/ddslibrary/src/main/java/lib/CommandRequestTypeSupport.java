 ...
 * CommandRequest.
 */
public class CommandRequestTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "CommandRequest";
    ...
    private static final CommandRequestTypeSupport _singleton
        = new CommandRequestTypeSupport();
     ...
     */
    public static CommandRequestTypeSupport get_instance() {
        return _singleton;
    }

    public static CommandRequestTypeSupport getInstance() {
        return get_instance();
    }
     ...
     * <code>this</code> is not a <code>CommandRequest</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        CommandRequest typedDst = (CommandRequest) destination;
        CommandRequest typedSrc = (CommandRequest) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  lib.CommandTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  lib.CommandTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        CommandRequest typedSrc = (CommandRequest) sample;
        ...
        currentAlignment += lib.CommandTypeSupport.get_instance().get_serialized_sample_size(
...
CommandRequest typedSrc = (CommandRequest) src;    
        ...
        lib.CommandTypeSupport.get_instance().serialize(endpoint_data,  typedSrc.cmd, dst, false, encapsulation_id,true,endpoint_plugin_qos);            
...
CommandRequest typedDst = (CommandRequest) dst;
        
            typedDst.clear();
    try {

            typedDst.cmd = (lib.Command)lib.CommandTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.cmd, src, false, true, endpoint_plugin_qos);            
...
CommandRequest typedDst = (CommandRequest) dst;
                     ...
                     Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            lib.CommandTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
CommandRequest typedDst = (CommandRequest) sample;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new CommandRequestDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new CommandRequestDataReader(native_reader, listener, mask, this);                
    ...
    protected CommandRequestTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,CommandRequestTypeCode.VALUE,CommandRequest.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected CommandRequestTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,CommandRequestTypeCode.VALUE,CommandRequest.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
